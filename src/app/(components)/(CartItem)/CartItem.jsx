  ...
  return (
    <div className="w-full bg-[#F5F6F8] px-6 py-6 flex items-center gap-6">
      ...
      <div className="flex flex-row justify-end gap-5 mr-10 m-auto w-fit max-md:mr-0 max-sm:flex-col max-sm:gap-2">
        <div className="text-black border-black border w-[50px] h-[50px] text-sm rounded-full flex justify-center items-center cursor-pointer hover:bg-[#3B3A39] hover:text-white max-md:w-[40px] max-md:h-[40px] max-sm:w-[30px] max-sm:h-[30px] max-sm:text-xs">
          -
        </div>
        <div className="text-black text-sm rounded-full flex justify-center items-center max-sm:text-xs">
          2
        </div>
        <div className="text-white bg-[#3B3A39] border-black border w-[50px] h-[50px] text-sm rounded-full flex justify-center items-center cursor-pointer max-md:w-[40px] max-md:h-[40px] max-sm:w-[30px] max-sm:h-[30px] max-sm:text-xs">
          +
        </div>
      </div>
      ...
      <div className="w-[18px] h-[18px] rounded-full cursor-pointer max-md:w-[15px] max-md:h-[15px] mb-24">
        <FontAwesomeIcon
          icon={faTrashCan}
          className="text-[#BFBFBF] hover:text-[#3B3A39]"
        />
      </div>
    </div>
  );
